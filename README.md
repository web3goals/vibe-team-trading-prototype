...
- **Create:** User logs in Yellow Network, names the group, and selects an AI Agent (e.g., Aggressive vs. Conservative).
...
- **Proposal:** Agent spots opportunity and proposes a trade.
- **Execution:**
  1.  Users sign to transfer USDC to Agent.
  2.  Users sign to move funds to execution wallet.
  3.  Agent executes trade via **LI.FI**.
...
- **Build:** Mint ENS name. Configure skills, personality, and instructions in ENS records.
- **Earn:** List Agent for others to use. Developer earns **0.7%** on transactions. Platform takes **0.3%**.
